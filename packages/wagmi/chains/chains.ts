...
export const onlychain: Chain = {
  id: 478,
  name: 'Only chain',
  network: 'only-chain',
  nativeCurrency: {
    decimals: 18,
    name: 'Only Chain Native Token',
    symbol: 'ONLY',
  },
  rpcUrls: {
    public: 'https://onlylayer.org',
    default: 'https://onlylayer.org',
  },
  blockExplorers: {
    default: { name: 'OnlyScan', url: 'https://scan.pulsechain.com' },
  },
  multicall: {
...
export const pulsechain: Chain = {
  ...
  rpcUrls: {
    public: 'https://pulsechain.publicnode.com',
    default: 'https://pulsechain.publicnode.com',
  },
  blockExplorers: {
    default: { name: 'OnlyScan', url: 'https://scan.pulsechain.com' },
  },

...
export const earnSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t('OnlySwap makes it easy to make your crypto work for you.'),
  reverse: true,
  primaryButton: {
    to: '/farms',
    text: t('Explore'),
  ...
  secondaryButton: {
    to: 'https://docs.onlyswap.org/products/yield-farming',
    text: t('Learn'),
    external: true,
  },
  images: {
...
export const cakeSectionData = (t: TranslateFunction): SalesSectionProps => ({
  ...
  bodyText: t(
    'CAKE token is at the heart of the OnlySwap ecosystem. Buy it, win it, farm it, spend it, stake it... heck, you can even vote with it!',
  ),
  reverse: false,
  primaryButton: {
  ...
  secondaryButton: {
    to: 'https://docs.onlyswap.org/tokenomics/only',
    text: t('Learn'),
    external: true,
  },

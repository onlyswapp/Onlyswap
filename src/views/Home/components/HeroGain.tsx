      ...
      >
        <Flex flex="1" flexDirection="column" style={{ paddingLeft: '10px' }}>
          <Heading scale="df" color="#fff" mb="24px" style={{ lineHeight: '30px' }}>
            {t("Why work for money when your money can work for you? Enjoy a consistent 2% daily yield with our state-of-the-art contract. It's smart, it's simple, it's decentralized.")}
          </Heading>
          <Heading scale="md" color="#fff" mb="24px" style={{ lineHeight: '30px' }}>
            {t('SIMPLY DEPOSIT $50 OR MORE OF THE XFN TOKEN TO START EARNING')}
          </Heading>
        </Flex>
        <Flex
        ...
        >
          <Flex flex="1" flexDirection="column" style={{ paddingLeft: '30px' }}>
            <div style={{ color: '#fff', fontSize: '38px' }}>
              {t('XAMPLIFY - LAUNCHING SOON')}
            </div>
            <BunnyWrapper>
              <Image src={bunnyImage} priority placeholder="blur" alt={t('Lunar bunny')} style={{ maxWidth: '50%', borderRadius: '25px', boxShadow: '0 0 8px rgba(0, 0, 0, 1)' }} />

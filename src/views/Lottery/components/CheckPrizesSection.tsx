    ...
    if (!account) {
      return (
        <Flex alignItems="center" justifyContent="center">
          <TicketImage src="/images/lottery/xfortune-ticket-l-logo.png" alt="lottery ticket" />
          ...
          <TicketImage src="/images/lottery/xfortune-ticket-r-logo.png" alt="lottery ticket" />
        </Flex>
      )
    }

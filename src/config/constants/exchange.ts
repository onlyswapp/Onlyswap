...
import { bscTokens, bscTestnetTokens, pulseChainTokens, onlyChainTokens, USDC, USDT, BUSD, WBTC_ETH } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.ONLY_CHAIN]: '0x7135A3b7D5aCA3CA33b6b3d9B872dEC4FDaD54c9',
}
...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.ONLY_CHAIN]: [onlyChainTokens.wbnb]
}
...
export const PINNED_PAIRS: { readonly [chainId in ChainId]?: [Token, Token][] } = {
  ...
  [ChainId.ONLY_CHAIN]: [
    [onlyChainTokens.wbnb, onlyChainTokens.dai],
  ],
}
...
// BNB
export const DEFAULT_INPUT_CURRENCY = 'ONLY'
// CAKE
export const DEFAULT_OUTPUT_CURRENCY = '0x5e7bF2742b39CE11578b9af2691f82928417585B'

// Handler string is passed to Gelato to use PCS router
export const GELATO_HANDLER = 'pancakeswap'
export const GENERIC_GAS_LIMIT_ORDER_EXECUTION = BigNumber.from(500000)

export const LIMIT_ORDERS_DOCS_URL = 'https://docs.onlyswap.org/products'

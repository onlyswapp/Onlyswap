...
const SlippageTabs = () => {
  ...
  } else if (slippageInputIsValid && userSlippageTolerance < 1200) {
    slippageError = SlippageError.RiskyLow
  } else if (slippageInputIsValid && userSlippageTolerance > 1500) {
          ...
          <Flex alignItems="center">
            <Box width="76px" mt="4px">
              <Input
                ...
                isSuccess={![1200, 1500].includes(userSlippageTolerance)}
              />
            </Box>

...
const WalletInfo: React.FC<WalletInfoProps> = ({ hasLowNativeBalance, onDismiss }) => {
  ...
  const isBSC = chainId === ChainId.ONLY_CHAIN
  const bnbBalance = useBalance({ addressOrName: account, chainId: ChainId.ONLY_CHAIN })
  ...
  return (
    <>
      ...
      {/* <Box mb="24px">
        ...
        <Flex alignItems="center" justifyContent="space-between">
          <Text color="textSubtle">{t('XFN Balance')}</Text>
